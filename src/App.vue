    ...
    <header class="sticky top-0 z-50 backdrop-blur-md bg-black/20 border-b border-cyan-400/20">
      <div class="max-w-7xl mx-auto px-4 py-4">
        ...
        <nav class="flex justify-center space-x-8">
          ...
          <RouterLink
            to="/event-form"
            class="px-6 py-3 bg-black/30 border border-orange-400/30 rounded-lg text-orange-300 hover:bg-orange-400/10 hover:border-orange-400 transition-all duration-300 font-bold text-lg no-underline"
            exact-active-class="bg-orange-400/20 border-orange-400 text-orange-200"
          >
            EVENT FORM
          </RouterLink>
        </nav>
